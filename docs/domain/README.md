...
| `subscription-billing.md` | ランク・サブスクリプション・初期費用・プラン変更 | `archive/service-spec.md`, `plan-change-flow.md`, `specs/001-seven-rank-pricing`                                                | ⏳ 作業中（担当: claude-code-subscription-billing） |
