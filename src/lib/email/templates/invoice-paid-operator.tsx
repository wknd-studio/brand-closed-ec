...
export function InvoicePaidOperatorEmail({
  orderId,
  customerEmail,
  adminOrderUrl,
}: Props) {
  return (
    <Html lang="ja">
      <Head />
      <Preview>Invoice入金確認 - {customerEmail} より入金がありました</Preview>
      <Body style={body}>
        <Container style={container}>
          <Heading style={h1}>Invoice入金確認</Heading>
          <Text style={text}>
            以下の注文のInvoice入金を確認しました。商品の手配を開始してください。
          </Text>
