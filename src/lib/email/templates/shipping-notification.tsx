...
export function ShippingNotificationEmail({ orderId, myPageUrl }: Props) {
  return (
    <Html lang="ja">
      <Head />
      <Preview>商品を発送しました - 注文番号: {orderId}</Preview>
      <Body style={body}>
        <Container style={container}>
          <Heading style={h1}>商品を発送しました</Heading>
          <Text style={text}>
            いつもご利用いただきありがとうございます。
            <br />
            ご注文の商品を発送いたしました。到着まで今しばらくお待ちください。
          </Text>
