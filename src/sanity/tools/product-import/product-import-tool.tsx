        ...
        <Card padding={3} radius={2} shadow={1} tone="primary">
          <Stack space={3}>
            ...
            <Stack space={2} as="ol" style={{ paddingLeft: "1.25em" }}>
              ...
              <Text size={1} as="li">
                「商品管理 →
                商品CSVカタログ」で、CSVファイル1本ごとにドキュメントを作成する。「保留中のCSV」欄に実際のCSVファイルをアップロードすると、CSV列マッピングで実際の列名をプルダウンから選べる。CSVにブランド列が無いデータは「デフォルトブランド」も設定する
              </Text>
              <Text size={1} as="li">
                上記で保存した「保留中のCSV」がそのままインポート対象になる（自動スクレイピングによる保留中CSVも同様に使える）
              </Text>
              <Text size={1} as="li">
                下の「1. 商品データソースを選択」〜「4.
                実行を確定する」の手順に沿って実行する
